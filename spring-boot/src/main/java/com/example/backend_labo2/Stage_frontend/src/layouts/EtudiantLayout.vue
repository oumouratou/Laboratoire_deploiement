    ...
    <aside class="sidebar" :class="{ collapsed: isCollapsed }">
      <div class="sidebar-header">
        <div class="logo">
          ...
          <span v-if="!isCollapsed">Étudiant</span>
        </div>
      ...
      <nav class="sidebar-nav">
        ...
        <div class="nav-section">
          ...
          <router-link to="/etudiant" class="nav-item" exact-active-class="active">
        ...
        <div class="nav-section">
          ...
          <router-link to="/etudiant/laboratoires" class="nav-item" active-class="active">
            <i class="fas fa-flask"></i>
            <span v-if="!isCollapsed">Laboratoires</span>
          </router-link>
          <router-link to="/etudiant/equipements" class="nav-item" active-class="active">
        ...
        <div class="nav-section">
          ...
          <router-link to="/etudiant/reservations" class="nav-item" active-class="active">
            <i class="fas fa-calendar-check"></i>
            <span v-if="!isCollapsed">Mes réservations</span>
          </router-link>
          <router-link to="/etudiant/nouvelle-reservation" class="nav-item" active-class="active">
            <i class="fas fa-plus-circle"></i>
            <span v-if="!isCollapsed">Nouvelle réservation</span>
          </router-link>
        </div>
        ...
        <div class="nav-section">
          ...
          <router-link to="/etudiant/reclamations" class="nav-item" active-class="active">
            <i class="fas fa-exclamation-circle"></i>
            <span v-if="!isCollapsed">Mes réclamations</span>
          </router-link>
          <router-link to="/etudiant/nouvelle-reclamation" class="nav-item" active-class="active">
            <i class="fas fa-plus-circle"></i>
        ...
        <div class="nav-section">
          ...
          <router-link to="/etudiant/notifications" class="nav-item" active-class="active">
      ...
      <div class="sidebar-footer">
        ...
        <router-link to="/etudiant/profil" class="profile-btn" v-if="!isCollapsed">
      ...
      <header class="top-header">
        ...
        <div class="header-right">
          <div class="header-actions">
            ...
            <NotificationBelle role="ETUDIANT" />
              ...
              <div class="user-menu" v-if="showUserDropdown">
                <div class="user-menu-header">
                  ...
                  <div class="user-menu-info">
                    ...
                    <span class="user-menu-role">Étudiant</span>
                  </div>
                </div>
                <div class="user-menu-divider"></div>
                <router-link to="/etudiant/profil" class="user-menu-item" @click="showUserDropdown = false">
...
const userName = computed(() => {
  ...
  return user ? `${user.prenom} ${user.nom}` : 'Étudiant'
})

const pageTitle = computed(() => {
  const titles: Record<string, string> = {
    '/etudiant': 'Tableau de bord',
    '/etudiant/laboratoires': 'Laboratoires',
    '/etudiant/equipements': 'Équipements',
...
<style scoped>
/* -------------------- */
/* Copie complète du style technicien adapté pour étudiant */
/* -------------------- */
